...
exports.REGEX_INLINE_MATH_DOLLARS = exports.REGEX_BLOCK_MATH_DOLLARS = void 0;
exports.default = markdownMath;
const REGEX_INLINE_MATH_DOLLARS = exports.REGEX_INLINE_MATH_DOLLARS = /\$\$(.+)\$\$/;
const REGEX_BLOCK_MATH_DOLLARS = exports.REGEX_BLOCK_MATH_DOLLARS = /\$\$\$\s+$/;
...
function mathInline(state, silent) {
  ...
  if (state.src.slice(state.pos, state.pos + inlineMathDelimiter.length) !== inlineMathDelimiter) {
    return false;
  }
...
function mathDisplay(state, start, end, silent) {
  ...
  if (state.src.slice(pos, pos + blockMathDelimiter.length) !== blockMathDelimiter) {
    return false;
  }
  ...
  if (firstLine.trim().slice(-blockMathDelimiter.length) === blockMathDelimiter) {
