...
class CommentMentionedEmail extends _BaseEmail.default {
  ...
  renderAsText(_ref6) {
    ...
    return `
${actorName} mentioned you in a comment on "${document.titleWithDefault}"${collection.name ? `in the ${collection.name} collection` : ""}.
...
`;
  ...
  render(props) {
    ...
    }, /*#__PURE__*/React.createElement(_Header.default, null), /*#__PURE__*/React.createElement(_Body.default, null, /*#__PURE__*/React.createElement(_Heading.default, null, document.titleWithDefault), /*#__PURE__*/React.createElement("p", null, actorName, " mentioned you in a comment on", " ", /*#__PURE__*/React.createElement("a", {
      href: threadLink
