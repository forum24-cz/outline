...
class IntegrationDeletedProcessor extends _BaseProcessor.default {
  async perform(event) {
    ...
    const uninstallHooks = _PluginManager.PluginManager.getHooks(_PluginManager.Hook.Uninstall);
...
exports.default = IntegrationDeletedProcessor;
_defineProperty(IntegrationDeletedProcessor, "applicableEvents", ["integrations.delete"]);